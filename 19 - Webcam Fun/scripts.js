...
function paintToCanvas() {
  ...
  return setInterval(() => {
    ...
    // writes the new image but the images that are beneath will continue to show through for 10 more frames
    ctx.globalAlpha = 0.1;
    // put them <back></back>
...
function takePhoto() {
  ...
  // will return base64, a text base representation of the picture
